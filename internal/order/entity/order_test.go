...
func TestGivenAnEmptyPrice_WhenCreateANewOrder_ThenShouldNotReceiveAnError(t *testing.T) {
	order := Order{ID: "123"}
	assert.Error(t, order.IsValid(), "invalid price")
}

func TestGivenAnEmptyTax_WhenCreateANewOrder_ThenShouldNotReceiveAnError(t *testing.T) {
